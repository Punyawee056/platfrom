            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">สาขา</h2>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <form action="sql/insert.php" method="post" enctype="multipart/form-data">
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                <input type="text" placeholder="ชื่อสาขา" class="form-control"
                                ...
                                <table class="datatables-basic table">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo $row_branch['code']; ?></td>
                                            <td><?php echo $row_branch['name']; ?></td>
                                            <td class="text-center" style="width: 220px;">
                                                <a class="btn btn-warning btn-icon box-shadow" style="width: 79.25px;"
                                                    data-toggle="modal"
                                                    data-target="#EditModel<?php echo $row_branch['id']; ?>"><i
                                                        data-feather='edit'></i> แก้ไข</a>
                                                <a href="#" class="btn btn-danger btn-icon box-shadow"
                                                    onclick="deleteItem(<?php echo $row_branch['id']; ?>,'<?php echo $row_branch['code'].' '.$row_branch['name']; ?>');"
                                        ...
                                        <div class="modal fade text-left"
                                            id="EditModel<?php echo $row_branch['id']; ?>" tabindex="-1"
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group">
                                                                <input type="text" placeholder="รหัสสาขา"
                                                                    ...
                                                                    value="<?php echo $row_branch['code']; ?>"
                                                                    required />
                                                            </div>
                                                            <label>ชื่อสาขา : </label>
                                                            <div class="form-group">
                                                                <input type="text" placeholder="ชื่อสาขา"
                                                                    class="form-control" name="name" maxlength="255"
                                                                    value="<?php echo $row_branch['name']; ?>"
                                                                    required />
                                                            </div>
                                                        </div>
    ...
    function deleteItem(id, classs) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location = `sql/delete.php?branch_id=${id}`;
            }
        })
    }
