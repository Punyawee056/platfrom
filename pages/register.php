            ...
            <div class="card mb-0">
                <div class="card-body">
                    <a href="javascript:void(0);" class="brand-logo">
                        ...
                        <h2 class="brand-text text-primary ml-1">ระบบสมัครเรียน</h2><br>
                    </a>
                    <h4 class="brand-text text-primary ml-1 text-center">สมัครสมาชิก</h4>

                    <form class="mt-2" action="" method="POST">
                        <div class="form-group">
                            <label for="name" class="form-label">ชื่อ</label>
                            <input type="text" class="form-control" name="fname" placeholder="ชื่อ" maxlength="100"
                                tabindex="1" required>
                        </div>

                        <div class="form-group">
                            <label for="name" class="form-label">นามสกุล</label>
                            <input type="text" class="form-control" name="lname" placeholder="นามสกุล" maxlength="100"
                                tabindex="1" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" name="email" placeholder="อีเมล" maxlength="100"
                                tabindex="1" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group input-group-merge form-password-toggle">
                                <input type="password" class="form-control form-control-merge" name="password"
                                    tabindex="2" placeholder="รหัสผ่าน" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group input-group-merge form-password-toggle">
                                <input type="password" class="form-control form-control-merge" name="confirm_password"
                                    tabindex="2" placeholder="รหัสผ่าน" required>
                                <div class="input-group-append">
                                    <span class="input-group-text cursor-pointer"><svg
                                            xmlns="http://www.w3.org/2000/svg" width="14" height="14"
                        ...
                        <button type="submit" name="submit"
                            ...
                            tabindex="3">สมัครสมาชิก</button><br>
                        มีบัญชีผู้ใช้งานอยู่แล้ว? <a href="login.php">เข้าสู่ระบบ</a>
                    </form>
