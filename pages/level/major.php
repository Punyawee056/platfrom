<?php 
  ...
  $sql = "SELECT * FROM `level` WHERE `id` = '".$_GET['level_id']."'";
  $result = $conn->query($sql);
  $row = $result->fetch_assoc();

  $sql_major = "SELECT * FROM `major` WHERE `level_id` = '".$_GET['level_id']."'";
...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static  " data-open="click"
                                ...
                                <table class="datatables-basic table">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo $row_major['code']; ?></td>
                                            <td><?php echo $row_major['name']; ?></td>
                                            <td class="text-center" style="width: 220px;">
                                                <a class="btn btn-warning btn-icon box-shadow" style="width: 79.25px;"
                                                    data-toggle="modal"
                                                    data-target="#EditModel<?php echo $row_major['id']; ?>"><i
                                                        data-feather='edit'></i> แก้ไข</a>
                                                <a href="#" class="btn btn-danger btn-icon box-shadow"
                                                    onclick="deleteItem(<?php echo $row_major['id']; ?>,'<?php echo $row_major['code'].' '.$row_major['name']; ?>',<?php echo $_GET['level_id']; ?>);"
                                        ...
                                        <div class="modal fade text-left"
                                            id="EditModel<?php echo $row_major['id']; ?>" tabindex="-1"
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group">
                                                                <input type="text" placeholder="สาขา"
                                                                    ...
                                                                    value="<?php echo $row_major['name']; ?>"
                                                                    required />
                                                            </div>
                                                        </div>
                                                        <input type="hidden" name="major_id"
                                                            value="<?php echo $row_major['id']; ?>">
                                                        <input type="hidden" name="level_id" value="<?php echo $_GET['level_id']; ?>">
                                                        <div class="modal-footer">
    ...
    // ลบ
    function deleteItem(id, classs, level_id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location = `sql/delete_major.php?major_id=${id}&level_id=${level_id}`;
            }
        })
    }
