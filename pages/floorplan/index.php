<?php 
  require_once('../includes/authen.php');
    ...
    $sql_floorplan = "SELECT * FROM `floorplan`";
    $result_floorplan = $conn->query($sql_floorplan);
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../../app-assets/css/floorplans.css">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">สถานะ Floorplan</h2>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <form action="sql/insert.php" method="post" enctype="multipart/form-data">
                                        <div class="modal-body">
                                            <label>สถานะ Floorplan : </label>
                                            <div class="form-group">
                                                <input type="text" placeholder="สถานะ Floorplan" class="form-control"
                                ...
                                <table class="datatables-basic table">
                                    <thead class="thead-default">
                                        <tr>
                                            ...
                                            <th class="text-center">สถานะ Floorplan</th>
                                    ...
                                    <tbody>
                                        <?php 
                                        $num = 0;
                                        while($row_floorplan = $result_floorplan->fetch_assoc()){
                                        $num++;
                                    ?>
                                        <tr>
                                            <!-- <td class="text-center" style="width: 110px;"><?php echo $num; ?></td> -->
                                            <td><?php echo $row_floorplan['name']; ?></td>
                                            <td class="text-center" style="width: 220px;">
                                                <a class="btn btn-warning btn-icon box-shadow" style="width: 79.25px;"
                                                    data-toggle="modal"
                                                    data-target="#EditModel<?php echo $row_floorplan['id']; ?>"><i
                                                        data-feather='edit'></i> แก้ไข</a>
                                                <a href="#" class="btn btn-danger btn-icon box-shadow"
                                                    onclick="deleteItem(<?php echo $row_floorplan['id']; ?>,'<?php echo $row_floorplan['name']; ?>');"
                                        ...
                                        <div class="modal fade text-left"
                                            id="EditModel<?php echo $row_floorplan['id']; ?>" tabindex="-1"
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form action="sql/update.php" method="post"
                                                        ...
                                                        <div class="modal-body">
                                                            <label>สถานะ Floorplan : </label>
                                                            <div class="form-group">
                                                                <input type="text" placeholder="สถานะ Floorplan"
                                                                    class="form-control" name="name" maxlength="255"
                                                                    value="<?php echo $row_floorplan['name']; ?>"
                                                                    required />
                                                            </div>
                                                        </div>
                                                        <input type="hidden" name="floorplan_id"
                                                            value="<?php echo $row_floorplan['id']; ?>">
                                                        <div class="modal-footer">
    ...
    function deleteItem(id, classs) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location = `sql/delete.php?floorplan_id=${id}`;
            }
        })
    }
