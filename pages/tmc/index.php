...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../../app-assets/css/tmcs.css">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">สถานะ TMC</h2>
                        </div>
                    </div>
                </div>
                                    ...
                                    <form action="sql/insert.php" method="post" enctype="multipart/form-data">
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                <input type="text" placeholder="สถานะ TMC" class="form-control"
                                ...
                                <table class="datatables-basic table">
                                    ...
                                    ?>
                                        ...
                                        <div class="modal fade text-left"
                                            id="EditModel<?php echo $row_tmc['id']; ?>" tabindex="-1"
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form action="sql/update.php" method="post"
                                                        ...
                                                        <div class="modal-body">
                                                            <label>สถานะ TMC : </label>
                                                            <div class="form-group">
                                                                <input type="text" placeholder="สถานะ TMC"
                                                                    class="form-control" name="name" maxlength="255"
                                                                    value="<?php echo $row_tmc['name']; ?>"
                                                                    required />
                                                            </div>
                                                        </div>
                                                        <input type="hidden" name="tmc_id"
                                                            value="<?php echo $row_tmc['id']; ?>">
                                                        <div class="modal-footer">
    ...
    function deleteItem(id, classs) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location = `sql/delete.php?tmc_id=${id}`;
            }
        })
    }
