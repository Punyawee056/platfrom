<?php 
  require_once('../includes/authen.php');
    ...
    $sql_ayear = "SELECT * FROM `academic_year`";
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">ปีการศึกษา</h2>
                        </div>
                    </div>
                </div>
                                ...
                                <table class="datatables-basic table">
                                    ...
                                    ?>
                                        ...
                                        <div class="modal fade text-left"
                                            id="EditModel<?php echo $row_ayear['id']; ?>" tabindex="-1"
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form action="sql/update.php" method="post"
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group">
                                                                <input type="number" placeholder="ปีการศึกษา"
                                                                    class="form-control" name="name" maxlength="4"
                                                                    value="<?php echo $row_ayear['name']; ?>"
                                                                    required />
                                                            </div>
                                                        </div>
                                                        <input type="hidden" name="ayear_id"
                                                            value="<?php echo $row_ayear['id']; ?>">
                                                        <div class="modal-footer">
    ...
    function deleteItem(id, classs) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location = `sql/delete.php?ayear_id=${id}`;
            }
        })
    }
