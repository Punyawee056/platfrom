            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Dealer</h2>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <form action="sql/insert.php" method="post" enctype="multipart/form-data">
                                        <div class="modal-body">
                                            <label>รหัส Dealer : </label>
                                            <div class="form-group">
                                                <input type="text" placeholder="รหัส Dealer" class="form-control"
                                                    name="code" maxlength="10" required />
                                            </div>
                                            <label>ชื่อ Dealer : </label>
                                            <div class="form-group">
                                                <input type="text" placeholder="ชื่อ Dealer" class="form-control"
                                ...
                                <table class="datatables-basic table">
                                    <thead class="thead-default">
                                        <tr>
                                            ...
                                            <th class="text-center">รหัส Dealer</th>
                                            <th class="text-center">ชื่อ Dealer</th>
                                    ...
                                    <tbody>
                                        <?php 
                                        $num = 0;
                                        while($row_dealer = $result_dealer->fetch_assoc()){
                                        $num++;
                                    ?>
                                        <tr>
                                            <!-- <td class="text-center" style="width: 110px;"><?php echo $num; ?></td> -->
                                            <td><?php echo $row_dealer['code']; ?></td>
                                            <td><?php echo $row_dealer['name']; ?></td>
                                            <td class="text-center">
                                                <a href="location.php?dealer_id=<?php echo $row_dealer['id']; ?>" class="btn btn-secondary btn-icon box-shadow"><i data-feather="map-pin"></i> Location</a>
                                            </td>
                                            <td class="text-center" style="width: 220px;">
                                                <a class="btn btn-warning btn-icon box-shadow" style="width: 79.25px;"
                                                    data-toggle="modal"
                                                    data-target="#EditModel<?php echo $row_dealer['id']; ?>"><i
                                                        data-feather='edit'></i> แก้ไข</a>
                                                <a href="#" class="btn btn-danger btn-icon box-shadow"
                                                    onclick="deleteItem(<?php echo $row_dealer['id']; ?>,'<?php echo $row_dealer['code'].' '.$row_dealer['name']; ?>');"
                                        ...
                                        <div class="modal fade text-left"
                                            id="EditModel<?php echo $row_dealer['id']; ?>" tabindex="-1"
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form action="sql/update.php" method="post"
                                                        ...
                                                        <div class="modal-body">
                                                            <label>รหัส Dealer : </label>
                                                            <div class="form-group">
                                                                <input type="text" placeholder="รหัส Dealer"
                                                                    class="form-control" name="code" maxlength="10"
                                                                    value="<?php echo $row_dealer['code']; ?>"
                                                                    required />
                                                            </div>
                                                            <label>ชื่อ Dealer : </label>
                                                            <div class="form-group">
                                                                <input type="text" placeholder="ชื่อ Dealer"
                                                                    class="form-control" name="name" maxlength="255"
                                                                    value="<?php echo $row_dealer['name']; ?>"
                                                                    required />
                                                            </div>
                                                        </div>
                                                        <input type="hidden" name="dealer_id"
                                                            value="<?php echo $row_dealer['id']; ?>">
                                                        <div class="modal-footer">
    ...
    function deleteItem(id, classs) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location = `sql/delete.php?dealer_id=${id}`;
            }
        })
    }
