            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">MFU Basketball Club</h2>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="content-body">
                ...
                <section class="about">
                    <div class="row">
                        ...
                        <img src="../../img in/bas2.jpg" alt="">
                        </div>
                        <div class="content">
                            <h3>Basketball Club</h3>
                            <p>ประวัติความเป็นมาของชมรม MFU Basketball Club

ชมรม MFU Basketball Club ก่อตั้งขึ้นเพื่อเป็นพื้นที่สำหรับนักศึกษามหาวิทยาลัยแม่ฟ้าหลวง (MFU) ที่รักในกีฬาบาสเกตบอลและต้องการพัฒนาทักษะในด้านนี้ ชมรมได้เริ่มต้นจากกลุ่มนักศึกษาที่รวมตัวกันเล่นบาสเกตบอลเป็นประจำ และได้เติบโตขึ้นเป็นชมรมอย่างเป็นทางการ เพื่อส่งเสริมให้นักศึกษาได้มีโอกาสฝึกฝนและพัฒนาทักษะการเล่นบาสเกตบอลอย่างต่อเนื่อง รวมถึงการเรียนรู้เทคนิคและการเล่นเป็นทีม สมาชิกชมรมจะมีโอกาสเข้าร่วมแข่งขันในรายการต่าง ๆ ทั้งในและนอกมหาวิทยาลัย </p>
