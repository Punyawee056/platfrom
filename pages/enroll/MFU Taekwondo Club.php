            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">MFU Taekwondo Club</h2>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="content-body">
                ...
                <section class="about">
                    <div class="row">
                        ...
                        <img src="../../img in/taekwondo2.jpg" alt="">
                        </div>
                        <div class="content">
                            <h3>Taekwondo Club</h3>
                            <p>อยากแข็งแกร่งขึ้นและมีทักษะการป้องกันตัวที่ยอดเยี่ยมไหม? ชมรมเทควันโดของเรายินดีต้อนรับคุณ! ไม่ว่าคุณจะไม่เคยฝึกมาก่อนหรือมีทักษะอยู่แล้ว เรามีการสอนที่เข้มข้นและสนุกสนาน พร้อมทั้งโอกาสที่จะพัฒนาตนเองในทุกๆ ด้าน เทควันโดจะช่วยเสริมสร้างวินัย ความอดทน และความมั่นใจในตนเองอย่างแท้จริง ชมรมของเราเปิดรับผู้ที่สนใจทุกระดับ ไม่ว่าจะเป็นมือใหม่หรือผู้ที่มีประสบการณ์ เรามีโค้ชที่เชี่ยวชาญและพร้อมที่จะสนับสนุนคุณในการฝึกฝนและพัฒนาทักษะ นอกจากนี้ เรายังมีการฝึกซ้อมและกิจกรรมร่วมกันอย่างสม่ำเสมอ เพื่อสร้างความสัมพันธ์ที่ดีและความรู้สึกเป็นครอบครัวเดียวกันระหว่างสมาชิก</p>
