            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">MFU Band</h2>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="content-body">
                ...
                <section class="about">
                    <div class="row">
                        ...
                        <img src="../../img in/Band2.jpg" alt="">
                        </div>
                        <div class="content">
                            <h3>MFU Band</h3>
                            <p>ประวัติความเป็นมาของชมรม MFU Band

ชมรม MFU Band ก่อตั้งขึ้นโดยนักศึกษามหาวิทยาลัยแม่ฟ้าหลวง (MFU) ที่มีใจรักในดนตรีและต้องการสร้างพื้นที่สำหรับการฝึกฝนและพัฒนาทักษะทางดนตรี โดยเน้นทั้งการเล่นดนตรีสากลและดนตรีไทย สมาชิกในชมรมมีทั้งนักดนตรีและนักร้องที่มาจากหลากหลายคณะและสาขาวิชา ชมรม MFU Band มุ่งเน้นให้สมาชิกได้มีโอกาสแสดงออกทางดนตรีในกิจกรรมต่าง ๆ ทั้งภายในและภายนอกมหาวิทยาลัย ไม่ว่าจะเป็นการแสดงในงานมหกรรม การแข่งขันดนตรี หรือการจัดงานดนตรีภายใน เพื่อเป็นการสร้างสรรค์บรรยากาศที่สนุกสนานและเสริมสร้างมิตรภาพระหว่างนักศึกษา</p>
