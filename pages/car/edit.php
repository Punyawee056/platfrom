                                        ...
                                        <div class="col-xl-3 col-md-3 col-12 mb-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="serial_no" maxlength="50"
                                                    placeholder="เลขเครื่อง" value="<?php echo $row['serial_no']; ?>" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-3 col-md-3 col-12 mb-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="mc_no" maxlength="50"
                                                    placeholder="เลขตัวถัง" value="<?php echo $row['mc_no']; ?>" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-3 col-md-3 col-12 mb-2">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" name="price" maxlength="10"
                                                    placeholder="ราคารวม VAT" value="<?php echo $row['price']; ?>" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-3 col-md-3 col-12 mb-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="aging" maxlength="50"
                                                    placeholder="Aging" value="<?php echo $row['aging']; ?>" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-3 col-md-3 col-12 mb-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="aging_rank" maxlength="50"
                                                    placeholder="Aging Rank" value="<?php echo $row['aging_rank']; ?>" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-3 col-md-3 col-12 mb-2">
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control" name="import_date"
                                                    placeholder="วันที่รถลง" value="<?php echo $row['import_date']; ?>" required>
                                            </div>
                                        </div>
                                    </div>

                                    <?php if ($row['status'] == 'จอง') {?>
                                    <div class="row ml-2 mr-2">
                                        <div class="col-xl-3 col-md-3 col-12 mb-2">
                                            <div class="form-group">
                                                <label for="buy_by">ชื่อลูกค้า :</label>
                                                <input type="text" class="form-control" name="buy_by" maxlength="255"
                                                    placeholder="ชื่อลูกค้า" value="<?php echo $row['buy_by']; ?>" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-3 col-md-3 col-12 mb-2">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" name="paid" maxlength="10"
                                                    placeholder="ชำระแล้ว" value="<?php echo $row['paid']; ?>" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-3 col-md-3 col-12 mb-2">
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control" name="delivery_date" maxlength="10"
                                                    placeholder="กำหนดส่งมอบ" value="<?php echo $row['delivery_date']; ?>" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-3 col-md-3 col-12 mb-2">
                                            ...
                                            ?>
                                                <option value="<?php echo $row_branch['id']; ?>" <?php echo $sel;?>>
