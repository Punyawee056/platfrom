<?php include_once('../../includes/authen.php'); 
    if(isset($_POST['submit'])) {
        ...
        //         $url_upload = '../../images/slip/'.$image_name;
        ...
        $model_desc_id = $_POST['model_desc_id'];
        $color_id = $_POST['color_id'];

        !empty($_POST['branch_id']) ? $branch_id = $_POST['branch_id'] : $branch_id = null;
        !empty($_POST['delivery_date']) ? $delivery_date = $_POST['delivery_date'] : $delivery_date = null;
        !empty($_POST['paid']) ? $paid = $_POST['paid'] : $paid = null;
