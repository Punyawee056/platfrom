<?php require_once('../../includes/authen.php');
  ...
  if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO `car` (`tmc_id`, `dealer_id`, `location_id`, `model_id`, `model_desc_id`, `color_id`, `price`, `import_date`, `ym_key`, `create_date`, `status`, `create_by`, `serial_no`, `mc_no`, `aging`, `aging_rank`, `remark`) 
            VALUES ('".$tmc_id."',
                    '".$dealer_id."',
                    '".$location_id."',
                    '".$model_id."',
