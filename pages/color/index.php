            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">สี</h2>
                        </div>
                    </div>
                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center" style="width: 220px;">
                                                ...
                                                <a href="#" class="btn btn-danger btn-icon box-shadow"
                                                    onclick="deleteItem(<?php echo $row_color['id']; ?>,'<?php echo $row_color['code'].' '.$row_color['name']; ?>');"
    ...
    function deleteItem(id, classs) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location = `sql/delete.php?color_id=${id}`;
            }
        })
    }
