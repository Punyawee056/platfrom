            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">คำนำหน้า</h2>
                        </div>
                    </div>
                </div>
                                    ...
                                    <form action="sql/insert.php" method="post" enctype="multipart/form-data">
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                <input type="text" placeholder="คำนำหน้า ไทย" class="form-control"
                                                    name="th" maxlength="100" required />
                                            </div>
                                            <label>คำนำหน้า อังกฤษ : </label>
                                            <div class="form-group">
                                                <input type="text" placeholder="คำนำหน้า อังกฤษ" class="form-control"
                                                    name="en" maxlength="100" required />
                                            </div>
                                        </div>
                                ...
                                <table class="datatables-basic table">
                                    <thead class="thead-default">
                                        <tr>
                                            ...
                                            <th class="text-center">คำนำหน้า ไทย</th>
                                            <th class="text-center">คำนำหน้า อังกฤษ</th>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo $row_prefix['th']; ?></td>
                                            <td><?php echo $row_prefix['en']; ?></td>
                                            <td class="text-center" style="width: 220px;">
                                                <a class="btn btn-warning btn-icon box-shadow" style="width: 79.25px;"
                                                    data-toggle="modal"
                                                    data-target="#EditModel<?php echo $row_prefix['id']; ?>"><i
                                                        data-feather='edit'></i> แก้ไข</a>
                                                <a href="#" class="btn btn-danger btn-icon box-shadow"
                                                    onclick="deleteItem(<?php echo $row_prefix['id']; ?>,'<?php echo $row_prefix['th'].' - '.$row_prefix['en']; ?>');"
                                        ...
                                        <div class="modal fade text-left"
                                            id="EditModel<?php echo $row_prefix['id']; ?>" tabindex="-1"
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form action="sql/update.php" method="post"
                                                        ...
                                                        <div class="modal-body">
                                                            <label>คำนำหน้า ไทย : </label>
                                                            <div class="form-group">
                                                                <input type="text" placeholder="คำนำหน้า ไทย"
                                                                    class="form-control" name="th" maxlength="100"
                                                                    value="<?php echo $row_prefix['th']; ?>"
                                                                    required />
                                                            </div>
                                                            <label>คำนำหน้า อังกฤษ : </label>
                                                            <div class="form-group">
                                                                <input type="text" placeholder="คำนำหน้า อังกฤษ"
                                                                    class="form-control" name="en" maxlength="100"
                                                                    value="<?php echo $row_prefix['en']; ?>"
                                                                    required />
                                                            </div>
                                                        </div>
                                                        <input type="hidden" name="prefix_id"
                                                            value="<?php echo $row_prefix['id']; ?>">
                                                        <div class="modal-footer">
    ...
    function deleteItem(id, classs) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location = `sql/delete.php?prefix_id=${id}`;
            }
        })
    }
