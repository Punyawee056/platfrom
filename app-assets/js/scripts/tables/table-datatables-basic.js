...
$(function () {
  ...
  if (dt_basic_table.length) {
    var dt_basic = dt_basic_table.DataTable({
      ...
      order: [[2, 'desc']],
      dom:
        '<<"head-label"><"dt-action-buttons text-right"B>><"d-flex justify-content-between align-items-center mx-0 row"<"col-sm-12 col-md-6"l><"col-sm-12 col-md-6"f>>t<"d-flex justify-content-between mx-0 row"<"col-sm-12 col-md-6"i><"col-sm-12 col-md-6"p>>',
      displayLength: 100,
      ...
      buttons: [
        ...
        // },
        // {
        //   text: feather.icons['plus'].toSvg({ class: 'mr-50 font-small-4' }) + 'เพิ่มข้อมูล',
